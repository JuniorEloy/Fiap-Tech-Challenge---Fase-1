...
def test_telefone_invalido_deve_lancar_value_error(telefone_invalido: str):
        ...
        assert (
            "O telefone não pode ser vazio" in mensagem_erro or 
            "O telefone com DDD deve possuir 10 ou 11 dígitos numéricos" in mensagem_erro or 
            "O código de DDD do telefone não pode iniciar com 0" in mensagem_erro
        )
