...
from app.shared.models.base import Base  # usando seu Base do pacote compartilhado
...
async def consultar_veiculo_por_placa(placa: str, db: AsyncSession = Depends(get_db)):
    """
